...
export async function generateMetadata({
    ...
    if (!product) {
        return {
            title: "𝐍𝐨 𝐩𝐫𝐨𝐝𝐮𝐜𝐭𝐬 𝐟𝐨𝐮𝐧𝐝",
            description: "𝐏𝐫𝐨𝐝𝐮𝐜𝐭 𝐧𝐨𝐭 𝐟𝐨𝐮𝐧𝐝",
        };
    }

    const name = String(product.name ?? "𝐏𝐫𝐨𝐝𝐮𝐜𝐭");
            ...
            <article className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-10">
                ...
                {description ? (
                    ...
                    <p className="mt-8 text-gray-500">
                        𝐓𝐡𝐢𝐬 𝐩𝐫𝐨𝐝𝐮𝐜𝐭 𝐡𝐚𝐬 𝐧𝐨 𝐝𝐞𝐭𝐚𝐢𝐥𝐬 𝐲𝐞𝐭
                    </p>
                )}
